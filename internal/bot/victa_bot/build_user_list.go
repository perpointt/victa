...
func (b *Bot) BuildUserList(ctx context.Context, chatID, tgID int64, company *domain.Company) (*tgbotapi.MessageConfig, error) {
	users, err := b.UserSvc.GetAllDetailByCompanyID(ctx, company.ID)
	if err != nil {
		return nil, err
	}
